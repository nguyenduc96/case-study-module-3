                    ...
                    <div class="card-body">
                        <table class="table table-striped">
                            ...
                            <c:forEach items="${orderDetails}" var="orderDetail">
                                <c:choose>
                                    <c:when test="${orderDetail.id == orderDetailEdit.id}">
                                        <form action="/order_detail?action=saveEdit&id=${orderDetailEdit.id}" method="post">
                                            <tr>
                                                <td>${orderDetailEdit.getProduct().getName()}</td>
                                                <td><input type="number" value="${orderDetailEdit.quantity}" name="quantity"><button type="submit">Save</button></td>
                                                <td><fmt:formatNumber value="${orderDetailEdit.beforeDiscountMoney}"></fmt:formatNumber></td>
                                                <td><fmt:formatNumber value="${orderDetailEdit.afterDiscountMoney}"></fmt:formatNumber></td>
                                            </tr>
                                        </form>
                                    </c:when>
                                    <c:otherwise>
...
<script>
    function updateDetail(id) {
        ...
        if( quantity < 0 ){
            ...
            window.location.href("/order_detail?action=saveEdit&id="+id+"&quantity="+quantity);
        }
    }
</script>
</body>
