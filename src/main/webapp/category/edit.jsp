                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
                                    <ul class="breadcome-menu" style="margin-right: 50px;margin-top:20px">
                                        ...
                                        <li><a href="/categories">Category list</a> <span class="bread-slash">/</span>
                                        </li>
                                        <li><span class="bread-blod">Edit catrgory</span>
                                        </li>
                                    </ul>
                                </div>
                            </div>
                                ...
                                <div class="row">
                                    <form method="post">
                                        ...
                                        <p>
                                            ...
                                            <input type="url" placeholder="Enter url image" name="image" value="${category.image}">
                                        </p>
                                        <button class="btn btn-outline-primary" style="min-width: 100px; color: black; margin-left: 100px">
                                            Edit
                                        </button>
