                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
                                    <ul class="breadcome-menu" style="margin-right: 50px;margin-top:20px">
                                        ...
                                        <li><span class="bread-blod">List brand </span>
                                        </li>
                                    </ul>
                                </div>
                            </div>
                ...
                <div class="sparkline8-hd">
                    <div class="main-sparkline8-hd">
                        <button type="button" class="btn btn-custon-rounded-three btn-primary" style="border-radius: 30px">
                            <a href="brands?action=create" style="color:#ffffff;">Create New Brand</a>
                        </button>
                    </div>
                    <div class="main-sparkline8-hd">
                        <p></p>
                                    ...
                                    <c:if test="${brand.isActive() == true}">
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <button><a onclick="confirmDelete(${brand.id})">Delete</a></button>
                                            </td>
                                        </tr>
                                    </c:if>
                                </c:forEach>
