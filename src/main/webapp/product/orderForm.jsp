...
<head>
    ...
    <link href="../table/plugins/css/select2-min.css?20171025" rel="stylesheet" type="text/css" />
    <link href="../table/plugins/css/checkout.css?20190719" rel="stylesheet" type="text/css" />
    <link href="../table/plugins/css/checkout.css?1564624970765" rel="stylesheet" type="text/css" />
                ...
                <div class="row">
                    <div class="col-md-6 col-lg-6">
                                    ...
                                    <div>
                                        ...
                                        <div class="form-group">
                                            <div class="field__input-wrapper field__input-wrapper--select">
                                                ...
                                                <select class="field__input field__input--select form-control filter-dropdown" name="BillingProvinceId" id="billingProvince" required data-error="Bạn chưa chọn tỉnh thành" bind-event-change="billingProviceChange('')" bind="BillingProvinceId">
                        ...
                        <div class="section pt10" bind-show="otherAddress">
                            ...
                            <div class="section__content">
                                <div bind-show="otherAddress" define="{shipping_address: {}, shipping_expand:true,show_district:  true ,show_ward:  false ,show_country:  true }" class="shipping  hide ">
                                    <div bind-show="shipping_expand || !otherAddress">
                                        ...
                                        <div class="form-group">
                                            <div class="field__input-wrapper field__input-wrapper--select">
                                                ...
                                                <select class="field__input field__input--select form-control filter-dropdown" name="ShippingProvinceId" id="shippingProvince" data-error="Bạn chưa chọn tỉnh thành" bind-event-change="shippingProviceChange('')" bind="ShippingProvinceId">
                                                    <option value=''>--- Chọn tỉnh thành ---</option>
                                    ...
                                    <div class="content-box__row">
                                        <div class="radio-wrapper">
                                            <div class="radio__input">
                                                <input class="input-radio" type="radio" value="290343" name="PaymentMethodId" id="payment_method_290343" data-check-id="4" bind="payment_method_id" checked>
                                            </div>
                    ...
                    <ul>
                        <li class="payment-icon-v2 payment-icon--4">
								...
								<i class="fa fa-money payment-icon-fa" aria-hidden="true"></i>
                                    ...
                                    <div class="radio-wrapper content-box__row content-box__row--secondary hide" id="payment-gateway-subfields-290343" bind-show="payment_method_id == 290343">
